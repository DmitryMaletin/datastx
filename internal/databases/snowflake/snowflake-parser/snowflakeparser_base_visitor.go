...
func (v *BaseSnowflakeParserVisitor) VisitComment_object_type(ctx *Comment_object_typeContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseSnowflakeParserVisitor) VisitGet(ctx *GetContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseSnowflakeParserVisitor) VisitOutofline_constraint(ctx *Outofline_constraintContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseSnowflakeParserVisitor) VisitVal(ctx *ValContext) interface{} {
	return v.VisitChildren(ctx)
}
