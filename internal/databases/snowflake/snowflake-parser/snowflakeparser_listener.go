...
type SnowflakeParserListener interface {
	...
	// EnterComment_object_type is called when entering the comment_object_type production.
	EnterComment_object_type(c *Comment_object_typeContext)
	...
	// EnterOutofline_constraint is called when entering the outofline_constraint production.
	EnterOutofline_constraint(c *Outofline_constraintContext)
	...
	// ExitComment_object_type is called when exiting the comment_object_type production.
	ExitComment_object_type(c *Comment_object_typeContext)
	...
	// ExitOutofline_constraint is called when exiting the outofline_constraint production.
	ExitOutofline_constraint(c *Outofline_constraintContext)
